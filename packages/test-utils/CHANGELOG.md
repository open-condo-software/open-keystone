...
- [`04bf1e4bb`](https://github.com/keystonejs/keystone-5/commit/04bf1e4bb0223f4e2e06664bbc9e95c51118eb84) [#2](https://github.com/keystonejs/keystone-5/pull/2) Thanks [@bladey](https://github.com/bladey)! - Removed setupFromConfig function.
...
- [`fe0c228b1`](https://github.com/keystonejs/keystone-5/commit/fe0c228b12530f6d384fa5eed9d5086768a24782) [#4676](https://github.com/keystonejs/keystone-5/pull/4676) Thanks [@timleslie](https://github.com/timleslie)! - Prisma artefacts are now generated in the `.keystone/prisma` directory.

### Patch Changes

- [`fc2b7101f`](https://github.com/keystonejs/keystone-5/commit/fc2b7101f35f20e4d729269a005816546bb37464) [#4691](https://github.com/keystonejs/keystone-5/pull/4691) Thanks [@timleslie](https://github.com/timleslie)! - Use the PrismaAdapter `prototype` migration mode.
...
- [`31ad142ea`](https://github.com/keystonejs/keystone-5/commit/31ad142ea058b178e2eda34e7ca4a29d1e99299c) [#4014](https://github.com/keystonejs/keystone-5/pull/4014) Thanks [@timleslie](https://github.com/timleslie)! - Renamed the `multiAdapterRunners` option `prisma` to `prisma_postgresql` to allow room for other Prisma variants in the future.
...
- [`e3455bd20`](https://github.com/keystonejs/keystone-5/commit/e3455bd2027534db29d1f9a8bca905f8eb33679e) [#3979](https://github.com/keystonejs/keystone-5/pull/3979) Thanks [@timleslie](https://github.com/timleslie)! - Added support for the `TEST_ADAPTER` environment variable to select a single adapter when running tests.
...
- [`5332988e3`](https://github.com/keystonejs/keystone-5/commit/5332988e3fafe6a3594f7dcecd79a9402df28015) [#3278](https://github.com/keystonejs/keystone-5/pull/3278) Thanks [@timleslie](https://github.com/timleslie)! - Replaced use of "p-finally" library with native Node code.
...
- [`753fa13ab`](https://github.com/keystonejs/keystone-5/commit/753fa13ab976cebdd145f4da948e13244612eedb) [#3252](https://github.com/keystonejs/keystone-5/pull/3252) Thanks [@timleslie](https://github.com/timleslie)! - The `knex` adapter now accepts `DATABASE_URL` as an environment variable for the database location.
...
- [`c6eac2dc2`](https://github.com/keystonejs/keystone-5/commit/c6eac2dc2dec857c668a5794fd84829d164563f3) [#3159](https://github.com/keystonejs/keystone-5/pull/3159) Thanks [@timleslie](https://github.com/timleslie)! - Updated to use `keystone.executeGraphQL` for all server-side GraphQL operations.
...
- [`3d40bd7d`](https://github.com/keystonejs/keystone-5/commit/3d40bd7dd39f2b5589012356dd2b1698eda4f0b2) [#2850](https://github.com/keystonejs/keystone-5/pull/2850) Thanks [@Vultraz](https://github.com/Vultraz)! - Switched to mongodb-memory-server-core.
...
- [`62f09391`](https://github.com/keystonejs/keystone-5/commit/62f093911879ca6b57ec0a06ce646e2296593c9a) [#2781](https://github.com/keystonejs/keystone-5/pull/2781) Thanks [@timleslie](https://github.com/timleslie)! - Added `authedGraphqlRequest` to support running queries with access control. Added `before` and `after` to the output of `multiAdapterRunners` to allow setting up a system to be shared across tests.
