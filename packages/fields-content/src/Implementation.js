...
import { Relationship, Text } from '@open-keystone/fields';
import { flatMap, unique, objMerge } from '@open-keystone/utils';
...
export class Content extends Relationship.implementation {
   ...
   * two halves and send them seperately (see `@open-keystone/field-views-loader`):
