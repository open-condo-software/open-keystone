...
- [`8d7056c8e`](https://github.com/keystonejs/keystone-5/commit/8d7056c8ed8d4fccfd61e64fc5fc2caf65899cee) [#4294](https://github.com/keystonejs/keystone-5/pull/4294) Thanks [@renovate](https://github.com/apps/renovate)! - Update dependency focus-trap-react to ^8.3.0

## 0.0.24

### Patch Changes

- [`ecbe1471f`](https://github.com/keystonejs/keystone-5/commit/ecbe1471fe22ca029a178a57dc216f6445b4053a) [#3609](https://github.com/keystonejs/keystone-5/pull/3609) Thanks [@renovate](https://github.com/apps/renovate)! - Updated dependency `focus-trap-react` to `^8.0.0`.

* [`d7fc663c3`](https://github.com/keystonejs/keystone-5/commit/d7fc663c3799afd2c646cc1ad6670f8e85002093) [#3689](https://github.com/keystonejs/keystone-5/pull/3689) Thanks [@JedWatson](https://github.com/JedWatson)! - Fixed touch-scrolling behaviour of `Dialog` and `Drawer` components.
...
- [`ed85a3d3`](https://github.com/keystonejs/keystone-5/commit/ed85a3d3776873893e9ba46f3b0c4d0f71bd6b6d) [#2108](https://github.com/keystonejs/keystone-5/pull/2108) - Made usages of `document.body` conditional so that the component doesn't immediately fail on the server
